...
#define OBJ_DIR "tex" //!< Le nom du répertoire contenant les fichiers objets ".tex".

#define FILE_TEXTURES_COUNT_POS 4 //!< la position dans le WAD du nombre de textures.
