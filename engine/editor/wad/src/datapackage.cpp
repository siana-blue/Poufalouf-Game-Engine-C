...
DataPackage::DataPackage() : m_intIndex(0), m_uintIndex(0), m_charIndex(0), m_floatIndex(0), m_doubleIndex(0), m_stringIndex(0), m_enumIndex(0), m_over(false) {}

DataPackage::DataPackage(ifstream& r_ifs, unsigned int dataCount) : m_intIndex(0), m_uintIndex(0), m_charIndex(0), m_floatIndex(0), m_doubleIndex(0), m_stringIndex(0), m_enumIndex(0), m_over(false)
{
	try
	{
		DataType type;
